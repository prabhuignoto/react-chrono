...
**[ADD IMAGE: vertical_alternating_full.png]**
*Example of alternating mode with rich media support*
...
**[ADD IMAGE: vertical_mode.png]**
*Clean vertical timeline layout with automatic card sizing*
...
**[ADD IMAGE: dark_mode.png]**
*Stunning dark mode with fully customizable theme properties*
...
**[ADD IMAGE: horizontal_all.jpg]**
*Dashboard-style view showing all timeline items simultaneously*
...
**🔹 Horizontal Mode** — Left-to-right chronological flow, perfect for storytelling and historical narratives

**🔹 Vertical Mode** — Top-to-bottom scroll-friendly layout, ideal for news feeds and mobile experiences

**🔹 Alternating Mode** — Cards alternate sides of a central axis, great for portfolios and company milestones

**🔹 Horizontal-All** — Shows all timeline items simultaneously, perfect for dashboards and comparisons

---

**[ADD IMAGE: vertical_mode_high_density.png]**
*High text density mode for information-rich timelines*
