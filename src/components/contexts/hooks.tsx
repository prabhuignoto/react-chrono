...
const convertLegacyToStable = (legacyContext: any): StableContextProps => {
  return {
    staticDefaults: {
      ...
      disableAutoScrollOnClick: legacyContext?.disableAutoScrollOnClick ?? false,
      disableInteraction: legacyContext?.disableInteraction ?? false,
      disableClickOnCircle: legacyContext?.disableClickOnCircle ?? false,
 ...
 */
export const useTimelineContext = (): CombinedContextProps =>
  useGlobalContext();
