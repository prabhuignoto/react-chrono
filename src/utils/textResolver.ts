...
export function createTextResolver(
  ...
  return {
    ...
    nextItem: () => resolve(
      i18nHelper?.navigation.next,
      buttonTexts?.next,
      'Next item'
    ),
    
    previousItem: () => resolve(
      i18nHelper?.navigation.previous,
      buttonTexts?.previous,
      'Previous item'
    ),
    
    playSlideshow: () => resolve(
      i18nHelper?.navigation.play,
      buttonTexts?.play,
      'Start slideshow'
    ),
    
    stopSlideshow: () => resolve(
      i18nHelper?.navigation.stop,
      buttonTexts?.stop,
      'Stop slideshow'
    ),
    
    pauseSlideshow: () => resolve(
      i18nHelper?.navigation.pause,
      undefined,
      'Pause slideshow'
    ),
    
    resumeSlideshow: () => resolve(
      i18nHelper?.navigation.resume,
      undefined,
      'Resume slideshow'
    ),
    ...
    searchResults: (current: number, total: number) => {
      return i18nHelper?.search.resultsCount(current, total) || `${current} of ${total}`;
    },
    
    noSearchResults: () => resolve(
      i18nHelper?.search.noResults,
      undefined,
      'No results found'
    ),
    
    searchNavigation: () => resolve(
    ...
    verticalLayout: () => resolve(
      i18nHelper?.layout.vertical,
      undefined,
      'Vertical layout'
    ),
    
    horizontalLayout: () => resolve(
      i18nHelper?.layout.horizontal,
      undefined,
      'Horizontal layout'
    ),
    
    alternatingLayout: () => resolve(
      i18nHelper?.layout.alternating,
      undefined,
      'Alternating layout'
    ),
    
    horizontalAllLayout: () => resolve(
      i18nHelper?.layout.horizontalAll,
      undefined,
      'Horizontal all layout'
    ),
    
    switchLayout: () => resolve(
      i18nHelper?.layout.switchLayout,
      undefined,
      'Switch layout'
    ),

    // Fullscreen texts
    enterFullscreen: () => resolve(
      i18nHelper?.fullscreen.enterFullscreen,
      undefined,
      'Enter fullscreen'
    ),
    
    exitFullscreen: () => resolve(
      i18nHelper?.fullscreen.exitFullscreen,
      undefined,
      'Exit fullscreen'
    ),
    
    fullscreenNotSupported: () => resolve(
      i18nHelper?.fullscreen.notSupported,
      undefined,
      'Fullscreen not supported'
    ),
    
    fullscreenError: () => resolve(
    ...
    // Content texts
    readMore: () => resolve(
      i18nHelper?.content.readMore,
      undefined,
      'Read More'
    ),
    
    showLess: () => resolve(
      i18nHelper?.content.showLess,
      undefined,
      'Show Less'
    ),
    
    expandContent: () => resolve(
      i18nHelper?.content.expand,
      undefined,
      'Expand'
    ),
    
    collapseContent: () => resolve(
      i18nHelper?.content.collapse,
      undefined,
      'Collapse'
    ),

    // Accessibility texts
    timelineNavigation: () => resolve(
      i18nHelper?.accessibility.timelineNavigation,
      undefined,
      'Timeline Navigation'
    ),
    
    timelineContainer: () => resolve(
      i18nHelper?.accessibility.timelineContainer,
      undefined,
      'Timeline Container'
    ),
    
    timelineItem: () => resolve(
    ...
    itemPosition: (current: number, total: number) => {
      return i18nHelper?.accessibility.itemPosition(current, total) || `Item ${current} of ${total}`;
    },

    // Status texts
    loading: () => resolve(
      i18nHelper?.status.loading,
      undefined,
      'Loading timeline...'
    ),
    
    error: () => resolve(
      i18nHelper?.status.error,
      undefined,
...
export function useTextResolver(): TextResolver {
  ...
  throw new Error('useTextResolver should be implemented when needed. Use useTimelineContext().textResolver instead.');
}