        ...
        <div className="flex items-center justify-between h-16 w-full">
          ...
          <div className="flex items-center space-x-2 shrink-0">
            ...
            <a
              ...
              className="flex items-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-2 rounded-lg bg-gray-800 text-white hover:bg-gray-700 transition-colors text-sm font-medium shadow-sm hover:shadow-md"
            >
