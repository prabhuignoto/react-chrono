...
![React-Chrono Logo](readme-assets/social-logo-small.png)
*👆 INSERT: social-logo-small.png as hero image*
...
![Vertical Alternating Timeline](readme-assets/vertical_alternating_full.png)
*👆 INSERT: vertical_alternating_full.png - Example of alternating mode with rich media*
...
![Vertical Mode Comparison](readme-assets/vertical_mode.png)
*👆 INSERT: vertical_mode.png - Clean vertical timeline layout*
...
*👆 INSERT: dark_mode.png - Stunning dark mode with customizable theme*
...
![Horizontal All Mode](readme-assets/horizontal_all.jpg)
*👆 INSERT: horizontal_all.jpg - Dashboard-style view showing all timeline items at once*
...
## Four Powerful Layout Modes

React-Chrono offers flexibility with four distinct timeline modes, each optimized for different use cases:

### 🔹 Horizontal Mode
Left-to-right chronological flow, perfect for storytelling and historical narratives

### 🔹 Vertical Mode
Top-to-bottom scroll-friendly layout, ideal for news feeds and mobile experiences

### 🔹 Alternating Mode
Cards alternate sides of a central axis, great for portfolios and company milestones

### 🔹 Horizontal-All
Shows all timeline items simultaneously, perfect for dashboards and comparisons

![Text Density Comparison](readme-assets/vertical_mode_high_density.png)
*👆 INSERT: vertical_mode_high_density.png - High text density mode for information-rich timelines*
...
## 📸 Image Upload Guide for Medium

When publishing this article on Medium, upload these images at the marked locations:

1. **Hero Image** (top) → `readme-assets/social-logo-small.png`
2. **After "What Is React-Chrono" section** → `readme-assets/vertical_alternating_full.png`
3. **In "Auto Card Height" section** → `readme-assets/vertical_mode.png`
4. **In "Enhanced Dark Mode" section** → `readme-assets/dark_mode.png`
5. **In "Real-World Use Cases" section** → `readme-assets/horizontal_all.jpg`
6. **In "Four Powerful Layout Modes" section** → `readme-assets/vertical_mode_high_density.png`

All images are located in the `/readme-assets/` directory of the repository.
